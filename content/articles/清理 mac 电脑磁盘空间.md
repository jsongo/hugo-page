...
banner_icon: 🚲
banner: "https://cdn.ethanlyn.com/banners/d8418fa48f2cc793c8f63aa13111635f.png"
title: 清理 mac 电脑磁盘空间
...
![8ee84296b354d8a922451b7d0e50e8a8_MD5|806x888](https://cdn.ethanlyn.com/2025/04/e2c574e7ab713206354294e0faac5ae1.webp)  
每一个都可以点进去看有哪些大文件（它按大小排序）。  
当然要更细的话，也可以用命令行，从上往下看某些目录里的占用情况：
```bash
du -hsx ~/* | sort -rh | head -10
```
![c63ab378d1ecb0a972305dfab65f9d0c_MD5|806x202](https://cdn.ethanlyn.com/2025/04/bba67c4fef0813913b1399566d099fc7.webp)  
然后找到大文件
