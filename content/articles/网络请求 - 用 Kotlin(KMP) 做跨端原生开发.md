...
banner_icon: 🧙🏼‍♀️
banner: "https://cdn.ethanlyn.com/banners/c1e2de3d85f49231f2290e3ec17b3940.jpg"
...
KMP Client 端接入现在变得很简单，也不需要什么特殊依赖：  
	![|500](https://cdn.ethanlyn.com/2025/01/035e39a399cfc90d0f6f9676a208ccaf.webp)  
...
- 当调用 `incoming.collect` 时，它会触发这个 `Flow` 开始工作，并且会将 `Flow` 发射出的每个数据项传递给 `collect` 函数内部定义的操作进行处理。Collect 参数是一个 lambda 表达式，参数就是一个 ServerSentEvent，定义如下图，遵守 SSE 的数据流协议，比较标准，没什么好说的。  
	![|500](https://cdn.ethanlyn.com/2025/01/f7c4b8c6b499c3c7eed20a4751139e6c.webp)
