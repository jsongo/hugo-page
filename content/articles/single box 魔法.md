...
banner_icon: 👰🏼‍♀️
banner: "https://cdn.ethango.top/banners/ce4ad62a66d8ac4c4027f3e054d6009e.jpg"
title: single box 魔法
...
到设置里，找到内核，点击更新，它会开始下载。  
 ![](https://cdn.ethango.top/upic/1744474649_Cy3pd0.webp)

# 使用

打开后，如果要使用 clash 的那个订阅地址，得安装一个插件，要不然报错：  
 ![|774x96](https://cdn.ethango.top/upic/1744474650_cV8faw.webp)
很简单，在 GUI 上找到插件中心，从列表中安装。先更新列表，然后就可以看到“节点转换”了。  
 ![](https://cdn.ethango.top/upic/1744474651_GkAXv5.webp)  
...
在顶部菜单上可以先把节点，其它的都跟 clashx 差不多。  
 ![](https://cdn.ethango.top/upic/1744474652_qh9YSN.webp)
...
先到插件中心找下 Tun 模式助手，它可以引导你怎么一步步安装 tun。  
 ![|0x0](https://cdn.ethango.top/upic/1744474653_IO5quG.webp)  
安装完之后，点击它，会让你运行一条命令，运行完之后再点击 tun 模型就会弹出提示，点允许就行。  
 ![](https://cdn.ethango.top/upic/1744474654_fQTGG6.webp)

## 插件

Gemini 插件。需要做配置，不好找，后来发现是要右击这个卡片，找到配置才行。  
 ![](https://cdn.ethango.top/upic/1744474656_KBYY1j.webp)  
通用设置里，把托盘菜单的这个选项打开。  
 ![](https://cdn.ethango.top/upic/1744474657_7WaCmo.webp)

## 命令行

Single-box 一般不干扰命令行，即使开启了 tun 模型，命令行也很可能没被代理。  
其实是有一个插件可以直接给你方法让命令行走代理：  
 ![|650x286](https://cdn.ethango.top/upic/1744474658_RLt7Ie.png)  
